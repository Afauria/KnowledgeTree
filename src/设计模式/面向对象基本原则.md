...
要求在软件复用时，尽量先使用组合或者聚合等关联关系来实现，其次才考虑使用继承关系来实现。（多组合，少继承）
...
参考资料：[C语言中文网-软件设计模式](http://c.biancheng.net/view/1317.html)。（整理的很齐全，有很多其他文章没有提到的点。）
